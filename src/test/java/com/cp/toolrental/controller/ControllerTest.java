...
@Import({RentalAgreementBuilder.class, ChargeDaysRulesEngine.class, WeekdayRule.class})
public class ControllerTest {
        ...
        class CheckoutValidationFailed {
                ...
                void checkout_shouldFailValidation_invalidDateFormat()
                        ...
                        mockMvc.perform(MockMvcRequestBuilders.post("/checkout")
                                        ...
                                        .contentType(MediaType.APPLICATION_JSON))
                                        .andExpect(MockMvcResultMatchers.status().isBadRequest())
                        .andExpect(MockMvcResultMatchers.jsonPath("$", Is.is("Date must match format: yyyy-mm-dd")));
        ...
        class CheckoutSuccess {
                ...
                void checkout_shouldProduceRentalAgreement_withProvidedToolCode() {
                        RentalAgreement rentalAgreement = controller.checkout(Order.builder()
                                        .toolCode("CHNS")
                                        .build());

                        assertEquals("My Favorite Tool", rentalAgreement.getTool().getToolCode());
                }
        }
}
